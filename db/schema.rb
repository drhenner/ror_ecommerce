...
ActiveRecord::Schema[7.0].define(version: 2026_03_14_045422) do
  ...
  create_table "brands", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.string "name"
  end
  ...
  create_table "item_types", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.string "name"
  end
  ...
  create_table "phone_types", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.string "name", null: false
  end
  ...
  create_table "referral_types", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.string "name", null: false
  end
  ...
  create_table "shipping_categories", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.string "name", null: false
  end
  ...
  create_table "shipping_rate_types", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.string "name", null: false
  end
  ...
  create_table "shipping_zones", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.string "name", null: false
  end
  ...
  create_table "tax_statuses", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.string "name", null: false
  end
