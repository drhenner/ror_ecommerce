...
describe Notifier, "Signup Email" do
    ...
    before(:each) do
      ...
      @user  = FactoryBot.create(:user, :email => 'myfake@email.com', :first_name => 'Dave', :last_name => 'Commerce')
...
describe Notifier, "#new_referral_credits" do
  ...
  before(:each) do
    @referring_user = FactoryBot.create(:user,     :email => 'referring_user@email.com', :first_name => 'Dave', :last_name => 'Commerce')
    @referral       = FactoryBot.create(:referral, :email => 'referral_user@email.com', :referring_user => @referring_user )
    @referral_user  = FactoryBot.create(:user,     :email => 'referral_user@email.com', :first_name => 'Dave', :last_name => 'referral')
...
describe Notifier, "#order_confirmation" do
    ...
    before(:each) do
      ...
      @order        = FactoryBot.create(:order, :email => 'myfake@email.com', :user => @user)
      @invoice        = FactoryBot.create(:invoice, :order => @order)
