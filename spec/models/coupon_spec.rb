...
describe Coupon do
  ...
  context "Percent Coupon" do
    before(:each) do
      @coupon_percent = FactoryBot.build(:coupon_percent)
    end
  ...
  context "Value Coupon" do
    before(:each) do
      @coupon_value = FactoryBot.build(:coupon_value)
    end
  ...
  context "coupon instance methods" do
    before(:each) do
      ...
      @coupon_value = FactoryBot.create(:coupon_value, :amount => 5.00)
    end
  ...
  context "coupon instance methods" do
    before(:each) do
      @order        = FactoryBot.create(:order)
      @coupon_percent = FactoryBot.create(:coupon_percent, :percent => 10)
    end
