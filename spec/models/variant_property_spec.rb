...
describe VariantProperty do
  context "Valid VariantProperty" do
    ...
    it 'should not be valid' do
      ...
      FactoryBot.create(:variant_property, :variant => variant, :property => property)
  ...
  context " VariantProperty instance methods" do
    it 'should return property_name' do
      property         = FactoryBot.create(:property, :display_name => 'name')
      variant_property = FactoryBot.create(:variant_property, :property => property)
