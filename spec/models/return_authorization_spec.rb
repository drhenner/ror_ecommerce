...
describe ReturnAuthorization, 'instance methods' do
  before(:each) do
    ...
    @return_authorization = FactoryBot.create(:return_authorization, :order => @order, :user => @user)
  end
  ...
  context ".set_order_number" do
    it 'should set number ' do
      return_authorization = FactoryBot.create(:return_authorization)
...
describe ReturnAuthorization, '#admin_grid(params)' do
  it "should return Return Authorizations " do
    return_authorization1 = FactoryBot.create(:return_authorization)
    return_authorization2 = FactoryBot.create(:return_authorization)
