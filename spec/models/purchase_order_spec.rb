...
describe PurchaseOrder, 'instance methods' do
  before(:each) do
    @purchase_order = FactoryBot.create(:purchase_order, :state => 'pending')
...
describe PurchaseOrder, ".pay_for_order" do
  it 'should pay for the order ' do
    purchase_order = FactoryBot.create(:purchase_order, :state => 'pending', :total_cost => 20.32)
...
describe PurchaseOrder, "#admin_grid(params = {})" do
  it "should return users " do
    purchase_order1 = FactoryBot.create(:purchase_order)
    purchase_order2 = FactoryBot.create(:purchase_order)
