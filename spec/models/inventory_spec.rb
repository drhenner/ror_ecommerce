...
describe Inventory do
  ...
  context ".add_count_on_hand=(num)" do
    ...
    it "should send OutOfStockNotification with qty_to_add" do
      inventory   = FactoryBot.create(:inventory, :count_on_hand => Variant::OUT_OF_STOCK_QTY + 1, :count_pending_to_customer => 0)
      @variant    = FactoryBot.create(:variant,   :inventory => inventory)
    ...
    it "should send LowStockNotification with qty_to_add" do
      inventory   = FactoryBot.create(:inventory, :count_on_hand => Variant::LOW_STOCK_QTY + 1, :count_pending_to_customer => 0)
      @variant    = FactoryBot.create(:variant,   :inventory => inventory)
