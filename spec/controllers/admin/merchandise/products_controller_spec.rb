...
describe Admin::Merchandise::ProductsController do
  ...
  it "create action should redirect when model is valid" do
    ...
    attrs = @product.attributes.merge('permalink' => "unique-permalink-#{SecureRandom.hex(6)}")
    post :create, params: { product: attrs }
  ...
  it "activate action should redirect when model is valid" do
    ...
    @product = FactoryBot.create(:product, :deleted_at => (Time.zone.now - 1.day))
