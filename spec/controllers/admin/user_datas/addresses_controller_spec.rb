...
describe Admin::UserDatas::AddressesController do
  ...
  it "index action should render index template" do
    address = FactoryBot.create(:address, addressable_id: @customer.id, addressable_type: 'User')
  ...
  it "create action should render new template when model is invalid" do
    address = FactoryBot.build(:address, addressable_id: @customer.id, addressable_type: 'User')
