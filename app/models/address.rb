...
class Address < ActiveRecord::Base
  ...
  validates :state_id,      :presence => true,  :if => Proc.new { |address| HADEAN_CONFIG['require_state_in_address'] }
  validates :country_id,    :presence => true,  :if => Proc.new { |address| !HADEAN_CONFIG['require_state_in_address'] }
